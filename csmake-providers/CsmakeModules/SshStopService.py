...
class SshStopService(CsmakeAspect):
    """Purpose: End execution of a SshService section
                May be used as an aspect on a section that would
                    need the service ended
       Options:
           tag - (OPTIONAL) Must match the tag given to SshService that
                   this section is ending
       Phases/JoinPoints:
           build - end execution of SshService
           end__build - end execution of SshService at the conclusion of the
    ...
    def _stopService(self, tag):
        try:
            ...
            pass
        SshServiceProvider.disposeServiceProvider(tag)
